...
export const FIXTURE_PROFILES:FixtureProfile[]=[
 ...
 {id:"generic-led-bar",manufacturer:"Generic / Amazon",model:"RGB LED Bar",name:"Generic RGB LED Bar",kind:"par",verified:false,note:"Whole-bar template.",modes:[mode("7ch-common","7ch · Dimmer RGB Strobe Macro Speed",[ch(0,"Dimmer","dimmer"),ch(1,"Red","red"),ch(2,"Green","green"),ch(3,"Blue","blue"),ch(4,"Strobe","strobe"),ch(5,"Macro","macro"),ch(6,"Speed")])]},
